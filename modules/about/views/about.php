            ...
            <div class="row row-mission-vsion">
                <div class="col-lg-6 col-md-6 col-12 col-mission-vision">
                    <div class="our-mission">
                        <h6 class="our-mission-title text-success">OUR MISSION</h6>
                ...
                <div class="col-lg-6 col-md-6 col-12 col-mission-vison">
                    <div class="our-vision">
                        <h6 class="our-vision-title text-success">OUR VISION</h6>
        ...
        <div class="core-values-content">
            ...
            <div class="row row-core">
                <div class="col-lg-4 col-md-4 col-12 my-auto col-core-value">
                    <img src="<?= THEME_DIR?>img/core values/Innovation.svg" class="img-core-value">
                ...
                <div class="col-lg-4 col-md-4 col-12 my-auto col-core-value">
                    <img src="<?= THEME_DIR?>img/core values/Safety.svg" class="img-core-value">
                ...
                <div class="col-lg-4 col-md-4 col-12 my-auto col-core-value-2">
                    <img src="<?= THEME_DIR?>img/core values/teamwork.svg" class="img-core-value">
        ...
        <div class="our-team-content">
            ...
            <div class="row team-members-content-1">
                <div class="team-member-content my-auto col-lg-4 col-md-4 col-12">                    
                    <img src="<?= THEME_DIR?>img/meet the team/Ayomide Oni.png" class="w-100 img-fluid img-team">
                ...
                <div class="team-member-content my-auto col-lg-4 col-md-4 col-12">                    
                    <img src="<?= THEME_DIR?>img/meet the team/Ugochi Izuora.png" class="w-100 img-fluid img-team">
                ...
                <div class="team-member-content my-auto col-lg-4 col-md-4 col-12">                    
                    <img src="<?= THEME_DIR?>img/meet the team/Deborah Dairo.png" class="w-100 img-fluid img-team">
                ...
                <div class="offset-md-2 offset-lg-2 col-lg-8 col-md-8 col-12">
                    <div class="row">
                        <div class="team-member-content my-auto col-lg-6 col-md-6 col-12">                    
                            <img src="<?= THEME_DIR?>img/meet the team/Blessing Aniekan.png" class="w-100 img-fluid img-team">
                        ...
                        <div class="team-member-content my-auto col-lg-6 col-md-6 col-12">                    
                            <img src="<?= THEME_DIR?>img/meet the team/Gloria Paul.png" class="w-100 img-fluid img-team">

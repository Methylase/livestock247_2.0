    ...
    <div class="wrapper-hoina-content">
        <div class="row row-hoina-content">
            <div class="col-lg-6 col-md-6 col-12 my-auto col-hoina-content">
                ...
                <a href="<?= BASE_URL ?>contact" class="btn btn-primary mt-1 contact-us">Contact us</a>                   
            </div>            
            <div class="col-lg-6 col-md-6 col-12 my-auto text-center col-focus-content">
                <img src="<?= THEME_DIR?>img/hoina-healthcare.png" class="w-100 img-hoina">              
            </div>                                          
        </div>                  
    </div>
</div>
<div class="wrapper-hoina-features">
    <div class="wrapper-hoina-features-content">        
        <div class="row row-hoina-feature">
            <div class="col-lg-4 col-md-4 col-12 my-auto col-hoina-feature">
                <div class="col-hoina-feature-content">
                    <img src="<?= THEME_DIR?>img//hoina/medication.svg" class="img-hoina">
                    <h6 class="hoina-feature-title">MEDICATION</h6>
            ...
            <div class="col-lg-4 col-md-4 col-12 my-auto col-hoina-feature">
                <div class="col-hoina-feature-content">
                    <img src="<?= THEME_DIR?>img/hoina/online market.svg">
                    <h6 class="hoina-feature-title">ONLINE MARKET</h6>
                    <p class="hoina-feature-content">
            ...
            <div class="col-lg-4 col-md-4 col-12 my-auto col-hoina-feature">
                <div class="col-hoina-feature-content">
                    <img src="<?= THEME_DIR?>img/hoina/farmgate.svg">
                    <h6 class="hoina-feature-title">FARM GATE</h6>
                    <p class="hoina-feature-content">
        ...
        <div class="row row-hoina-feature">
            <div class="col-lg-4 col-md-4 col-12 my-auto col-hoina-feature">
                <div class="col-hoina-feature-content">
                    <img src="<?= THEME_DIR?>img/hoina/convenience.svg">
                    <h6 class="hoina-feature-title">CONVENIENCE</h6>
                    <p class="hoina-feature-content">
            ...
            <div class="col-lg-4 col-md-4 col-12 my-auto col-hoina-feature">
                <div class="col-hoina-feature-content">
                    <img src="<?= THEME_DIR?>img/hoina/finance.svg">
                    <h6 class="hoina-feature-title">FINANCE</h6>
                    <p class="hoina-feature-content">
            ...
            <div class="col-lg-4 col-md-4 col-12 my-auto col-hoina-feature">
                <div class="col-hoina-feature-content">
                    <img src="<?= THEME_DIR?>img/hoina/production.svg">
                    <h6 class="hoina-feature-title">PRODUCTION</h6>
                    <p class="hoina-feature-content">
        ...
        <div class="row row-gallery-content">
            <div class="col-lg-6 col-md-6 col-12 my-auto col-gallery-content">
                <div class="text-center">
                    <img src="<?= THEME_DIR?>img/gallery/gallery-1.png" class="w-100 h-100 img-gallery-1" alt="" />
                </div>   
            </div>            
            <div class="col-lg-6 col-md-6 col-12 my-auto col-gallery-content">
                <div class="row row-gallery">
                    <div class="col-lg-12 col-md-12 col-12 col-gallery">
                        <div class="text-center">
                            <img src="<?= THEME_DIR?>img/gallery/gallery-2.png" class="w-100 img-fluid img-gallery-2">
                        </div>  
                    </div>
                    <div class="col-lg-12 col-md-12 col-12 col-gallery">
                        <div class="text-center">
                            <img src="<?= THEME_DIR?>img/gallery/gallery-3.png" class="w-100 img-fluid img-gallery-3">
                        </div> 
                    </div>
                </div>

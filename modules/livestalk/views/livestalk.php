    ...
    <div class="wrapper-livestalk-content">
        ...
        <h2 class="wrapper-livestalk-series-title text-center font-weight-bold">Let <span class="text-success">Talk</span> Livestock</h2>
            <div class="col-livestalk-content">
                ...
                <a href="https://www.youtube.com/channel/UCYSw3HTXyWbc1rFKhlifK8Q" class="btn btn-primary">Watch series</a>
                </div>  
            </div>                                                              
    </div>
</div>
      ...
      <div class="row row-livestalk-series">
        <div class="col-lg-4 col-md-4 col-12 my-auto livestalk-series">
          <div class="col-livestalk-series">
            <img src="<?= THEME_DIR?>img/livestalk/livetalk 1.0.png" class="img-livestalk-series">               
            ...
            <a href="https://www.youtube.com/watch?v=D-yoR9HG1jI" class="btn btn-primary btn-series">Watch</a>
          </div>               
        </div>
        <div class="col-lg-4 col-md-4 col-12 my-auto livestalk-series">
          <div class="col-livestalk-series">
            <img src="<?= THEME_DIR?>img/livestalk/livetalk 2.0.png" class="img-livestalk-series">
            ...
            <a href="https://www.youtube.com/watch?v=0nKpypI8-xk" class="btn btn-primary btn-series">Watch</a>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-12 my-auto livestalk-series">
          <div class="col-livestalk-series">
            <img src="<?= THEME_DIR?>img/livestalk/livetalk 3.0.png" class="img-livestalk-series">
            <h5 class="pl-4 mb-2 impact-series-title">LIVETALK 3.0</h5>
            <p class="pl-4 livestalk-series-content">
                Economic Development of Women in Africa: The role of Agriculture.
            </p>
            <a href="https://www.youtube.com/watch?v=3Jqu_Cqvxyo" class="btn btn-primary btn-series">Watch</a>
          </div>                
        </div>
      </div>
    </div>

    ...
    <div    class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div class="float-right text-warning" id="createPostToggle"><i class="fas fa-plus" id="close"></i></div>
            </div>
            <div class="card-body" id="create-post-body">
                <form class="form" action="<?= BASE_URL ?>create_post/submit" enctype="multipart/form-data" method="POST">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea  id="post-description" name="post-description" class="form-control" placeholder="Enter email" ></textarea>
                                <span class="text-danger">
                                    <?php 

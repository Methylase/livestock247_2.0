...
function tgpDrawNavFolderIcon(folderName, uploadedImagesGrid) {
  ...
  const boxImage = document.createElement("<?= BASE_URL?>img");
...
function tgpInstantFilePreview(input) {
  const preview = document.createElement("<?= BASE_URL?>img");
...
function tgpChooseThisPicture(event) {
  ...
  const selectedPic = clickedBox.querySelector("<?= BASE_URL?>img");
...
function tgpAddNewShowcasePic(selectedPic, targetModalBody, selectedPicShape) {
  ...
  const newImage = document.createElement("<?= BASE_URL?>img");
  newImage.src = picUrl;
...
function tgpInsertImage(imgPath, delayTime = 1300) {
  ...
  const newImg = document.createElement("<?= BASE_URL?>img");
  newImg.src = imgPath;
...
function tgpBuildEditImgModal(clickedImg) {
  ...
  const img = document.createElement("<?= BASE_URL?>img");
